# Code repository for the low-cost robot arm Koch V1.1
...
Furthermore, the authors would like to thank Jess Moss for her hardware adaptions: https://github.com/jess-moss/koch-v1-1 (Apache License 2.0).

The mujoco model was adapted from the original repository by Alexander Koch to fit the new hardware strucuture and can be found at: https://github.com/s1lent4gnt/mujoco_menagerie/tree/lilkm/add-kochv1.1/low_cost_robot_arm (Apache License 2.0).
